...
class CafeForm(FlaskForm):
    ...
    location = StringField('Location link', validators=[DataRequired(), URL()])
    opening = StringField('Open', validators=[DataRequired()])
    closing = StringField('Close', validators=[DataRequired()])
    coffee = SelectField('Coffee', choices=["️️️️☕️☕️☕️☕️☕️", "☕️☕️☕️☕️", "☕️☕️☕️", "☕️☕️", "☕️"], validators=[DataRequired()])
